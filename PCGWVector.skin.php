...
?>
	...
	<div style="position:absolute; top:2.25em; width:100%">
		<div class="main_width" style="margin:5px auto">
			...
			<div style="position:absolute; top:90px; height:0px" class="main_width">
				<div style="float:right">
					<span style="font-family:courier; font-style:; text-transform:uppercase; text-shadow: 1px 1px 1px rgba(0,0,0,0.3);">
