	...
	<div style="position:absolute; top:2.25em; width:100%">
		<div class="main_width" style="margin:5px auto">
			...
			<div class='ipsList_inline right' style='margin-top:18px; margin-right:44px; float:right'>
				<a href="http://www.patreon.com/PCGamingWiki"><img src="http://pcgamingwiki.com/images/thumb/f/fe/Patreon_Logo.png/100px-Patreon_Logo.png" alt='Patreon' style="height:34px; width:150px" /></a>
			</div>
			<?php } 
